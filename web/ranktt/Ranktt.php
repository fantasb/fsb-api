...
class Ranktt {
	...
	*/
	...
	/**
		Example:
			if (Ranktt::g($_POST,'param') == 'abc') ...
			instead of
			if (isset($_POST['param']) && $_POST['param'] == 'abc') ...
		Example:
			$host = Ranktt::g($_SERVER,array('HOST_NAME','SERVER_NAME'));
			instead of
	...
	*/
	...
	/**
		...
		Example:
			...
			Ranktt::putDeep($house,'kitchen>oven','bread');
			Ranktt::putDeep($house,'bedroom>dresser[]','shirt');
			Ranktt::varDump($house);
	*/
	public static function putDeep(&$root, $where, $what) {
		/**
			Ex:
				...
				\ranktt\Ranktt::putDeep($house,'kitchen>oven','bread');
				\ranktt\Ranktt::putDeep($house,'bedroom>dresser[]','shirt');
				\ranktt\Ranktt::putDeep($house,'kitchen>cabinets[]>corner','salt');
			Note:
...
*/
	...
	*/
	public static function strToTime($str, $time=null) {
		...
		date_default_timezone_set(self::rankttTmz());
	...
	public static function ranktTmz() {
		if (isset(self::$TMZ))
			return self::$TMZ;
