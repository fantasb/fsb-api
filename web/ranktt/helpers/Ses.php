...
use \ranktt\helpers\Exception as HelperException;
	...
	private static function getSes(){
		if (self::$ses === null) {
			...
			self::$ses = \Aws\Ses\SesClient::factory(array(
				'key' => Ranktt::getConfig('awsAccessKey'),
				'secret' => Ranktt::getConfig('awsAccessSecret'),
				//'default_cache_config' => '/tmp/cache/',
				'certificate_authority' => true,
				'region' => Ranktt::getConfig('awsRegion')
			));
		}
		return self::$ses;
	}
