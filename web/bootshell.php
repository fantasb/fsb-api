...
define('APP_PATH', WEBROOT.'/ranktt');
...
use \app\Ranktt::loadConfig( WEBROOT.'/config.php', WEBROOT.'/config.local.php' );
...
if (REQUEST_PATH !== null) {
	\ranktt\Router::route(REQUEST_PATH, REQUEST_METHOD);
}
